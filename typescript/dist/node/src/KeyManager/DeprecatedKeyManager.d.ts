...
export default class DeprecatedKeyManager {
    ...
    swapIndex: number;
    constructor();
    static create_Id25519_fromEntropy(entropy: Buffer, swapIndex?: number): Promise<DeprecatedKeyManager>;
    static generate_Id25519(): Promise<DeprecatedKeyManager>;
    get id(): Buffer;
    getCypher(): Promise<{
    ...
    getSecret(): Buffer;
    static fromSecret(secret: Buffer): DeprecatedKeyManager;
    static instantiate(obj: any): DeprecatedKeyManager;
    static fromId(id: Buffer): DeprecatedKeyManager;
